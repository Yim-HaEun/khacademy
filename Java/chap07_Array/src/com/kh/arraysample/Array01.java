...
public class Array01 {
	...
	public static void main(String[] args) {
		...
		/*
		 동일한 데이터 타입을 가진 여러값을 한 곳에 저장하고 인덱스를 사용하여 각 값에 접근할 수 있도록 제공
		 ...
		 2. 같은 데이터 타입 : 배열 내에 모든 요소는 동일한 데이터 타입을 가져야합니다.
		 			  	  ex) int타입의 배열은 모든 요소 정수
		 			  	  
		 3. index 기반 접근 : 각 배열 요소는 순차적인 인덱스를 가지며 0부터 시작해서 배열크기 -1까지의 값을 가진다.
		 					인덱스를 사용해서 특정 위치에 있는 요소 접근 가능
		 					ex)배열 크기 = 5로 줬다면 index는 0 ~ 4
		...
		int[] arr = new int[5]; //index 0~4까지 만들기
		//배열은 int 5개를 생성
		...
		//String[] stringArray = {"","","",""};
		stringArray[0] = "가";
		System.out.println("String Array[0] : "+ stringArray[0]); //{가}
		
		//String[] nameArray = {"임하은","홍길동","고양이"};

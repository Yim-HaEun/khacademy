...
public class IfElseIfSample {
	...
	public static void main(String[] args) {
		...
		int age = 20;
		if (age == 20) {
			System.out.println("해외 여행을 갈거야");
		}else if(age >=20) {
			System.out.println("세계여행 갈거야");
		}else {
			System.out.println("집에 있을거야!");
		}
		//int score = 85; 만약 90점이 넘으면 A 90점이면 B+ 90 미만이면 B
		...
		//int myAge = 15; 나의 나이가 15살 일 때 청소년인지 어린이인지 성인인지 출력하기
		 
		int myAge = 15;
		if(myAge >= 20) {
			System.out.println("성인입니다."); //21~
		}else if(myAge >= 15) { //14~20살 청소년
